...
public:
    ...
    virtual void init() = 0;
    virtual void update(float deltaTime, Player* player, ParticleSystem* particles);
...
protected:
    void createWall(const glm::vec3& position, const glm::vec3& scale, const glm::vec3& color, int materialType = 0);
    void createFloor(const glm::vec3& position, const glm::vec3& scale, const glm::vec3& color);
};
